...
class DataAcquirerSpectral(core.QObject):
    ...
    def acquire(self, n):
        ...
        dc.createAcquisitionArrays(self, self.x, self.buflen)   # probe-only buffer
        dc.createAcquisitionArrays(self, self.x, self.buflen)   # pump-probe buffer
        dc.createAcquisitionArrays(self, self.x, self.n)        # probe-only signal
        dc.createAcquisitionArrays(self, elf.x, self.n)        # pump-probe signal
        ...
        dc.createFFTArrays(self, self.x, self.n)    
