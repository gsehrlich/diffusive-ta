...
One Python error that's probably more common than I think: ``Got multiple values for keyword argument _____''. Sometimes this is caused by sloppy function definitions involving \verb **kwargs  or sloppy function calls to the same, but both times I have run into it in this problem it was because I was either forgetting \verb self  in a method definition or including it in a method call!
